...
public class ItemMapper {
    ...
    public ItemResponseDto itemToResponseDto(Item item) {
        ...
        return ItemResponseDto.builder()
                ...
                .lastBooking(last.isPresent() ? BookingMapper.bookingToShort(item.getLastBooking()) : null)
                .nextBooking(next.isPresent() ? BookingMapper.bookingToShort(item.getNextBooking()) : null)
